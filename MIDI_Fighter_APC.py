...
# script for the MIDI Fighter in APC emulation mode
...
class MIDI_Fighter_APC(ControlSurface):
    ...
    def __init__(self, c_instance):
        ...
        self.log_message(time.strftime("%d.%m.%Y %H:%M:%S", time.localtime()) + "--------------= MIDI Fighter log opened =--------------") # Writes message into Live's main log file. This is a ControlSurface method.
    ...
    def _setup_session_control(self):
        is_momentary = True
        self._session = SpecialSessionComponent(4, 3)
